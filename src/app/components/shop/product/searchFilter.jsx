...
function SearchPagination({
  ...
  const resultsPerPage = recordsPerPage ? recordsPerPage : 20;
  ...
  const url = `/products/${searchValue}?search=${searchValue}`
          ...
          <div className="py-4 flex items-center flex-wrap justify-center">
            ...
            <a
              ...
              href={
                noRedirect
                  ? '#'
                  : `${url}&offset=${offsetCount - resultsPerPage}&${
                      queryString ? queryString : ''
                    }`
              }
              className={`border border-solid py-[18px] hover:border-[#FFCD00] px-6 ${
            ...
            {pageNumbers.map((pageNumber) => (
              <a
                ...
                href={
                  noRedirect
                    ? '#'
                    : `${url}&offset=${resultsPerPage * (pageNumber - 1)}&${
                        queryString ? queryString : ''
                      }`
                }
            ...
            <a
              ...
              href={
                noRedirect
                  ? '#'
                  : `${url}&offset=${resultsPerPage * (totalPages - 1)}&${
                      queryString ? queryString : ''
                    }`
              }
              className={`border border-solid py-[18px] hover:border-[#FFCD00] px-6  ${
                ...
                onKeyDown={(e) => {
                  if (e.key === 'Enter') {
                    if (noRedirect) {
                      ...
                      window.location.href = `${url}&offset=${resultsPerPage * (searchPage - 1)}&${queryString ? queryString : ''}`;
                    }
                  }
                }}
              />
